...
<main>
    <div class="container">
        <h3 class="mt-3 text-light">Изменить - <?= $category->name() ?></h3>
        <hr>
    </div>
    <div class="container d-flex">
        <form action="" method="post" class="d-flex flex-column justify-content-center w-50 gap-2 mt-5 mb-5">
                ...
                <div class="col-md">
                    <div class="form-floating">
                        <input type="text" class="form-control  <?php echo $session->has('name') ? 'is-invalid' : '' ?>"
                            id="name" name="name" placeholder="Пацаны" value="<?= $category->name() ?>">
            ...
            <div class="row g-2">
                <button class="btn btn-success">Обновить жанр</button>
            </div>
        </form>
    </div>
